...
BEGIN
    IF NOT EXISTS (
        SELECT 1
        FROM information_schema.table_constraints
        WHERE table_name = 'journal_vouchers'
          AND constraint_name = 'journal_vouchers_source_type_check'
    ) THEN
        ALTER TABLE journal_vouchers
        ADD CONSTRAINT journal_vouchers_source_type_check
        CHECK (source_type IN ('manual','annual_carry_forward'));
    END IF;
END $$;
